...
import { LuisRecognizer, MemoryBotStorage, Message, UniversalBot } from "botbuilder";
...
bot.dialog('InfoDialog', (session) => {
    const text = 'Name: ' + (process.env.npm_package_name || 'restaurant-bot') + '\n' + 
